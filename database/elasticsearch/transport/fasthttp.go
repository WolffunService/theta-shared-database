...
// FastHTTP implements the elastictransport interface with
...
//
func (t *FastHTTP) RoundTrip(req *http.Request) (*http.Response, error) {
...
//
func (t *FastHTTP) copyRequest(dst *fasthttp.Request, src *http.Request) *fasthttp.Request {
...
//
func (t *FastHTTP) copyResponse(dst *http.Response, src *fasthttp.Response) *http.Response {
